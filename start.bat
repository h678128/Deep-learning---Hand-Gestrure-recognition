...
if not exist "modell\landmark_heatmap11_best.pt" (
    ...
    curl -L -o "modell\landmark_heatmap11_best.pt" "https://github.com/h678128/Deep-learning---Hand-Gestrure-recognition/releases/download/v1.0/landmark_heatmap11_best.pt"
    if errorlevel 1 (
